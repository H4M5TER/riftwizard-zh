...
spells = {
    ...
    "Devour Flesh": "吞噬血肉",
    "Dominate": "支配术",
    "Earthen Sentinel": "召唤大地哨兵",
    "Earthquake": "地震术",
    "Flame Gate": "火焰之门", # 寒冰之墙
    "Frostfire Hydra": "召唤霜火九头蛇", # 作为海德拉你不能移动是正常的吗？
    "Ghostball": "鬼球术",
    "Giant Bear": "召唤巨熊",
    "Glass Orb": "玻璃法球",
    "Holy Armor": "神圣护甲",
...
skills = {
    ...
    "Demonic Cruelty": "邪魔施虐", 
    "Earthwrath": "大地之怒",
    "Fae Malevolence": "妖灵恶戏", # TODO
    "Fiery Judgement": "火焰审判",
    "Ghostfire": "鬼火",
    "Hemocorruption": "腐败污血", # TODD
    "Holy Thunder": "神圣雷霆",
    "Hordemancer": "呼朋引伴", # TODO
    "Horror": "恐惧",
    "Hypocrisy": "伪善",
    "Master of Space": "空间领主",
    "Master of Time": "时间领主",
    "Multimancy": "法术多发",
...
upgrades = {
    ...
    "Magic Eggs": "魔法胎教",
    "Radiant Eggs": "炫光龙蛋",
    "Scale Harvest": "鳞片召还", # TODD
    "Aelf Horde": "精灵部族",
    "Fae Aelves": "仙廷精灵", # TODD
    "Elite Aelves": "精英精灵",
...
equipments = {
    ...
    "Storm Oculus": "风暴法眼",
    "Void Oculus": "虚空法眼",
    "Pyrostatic Oculus": "聚能法眼",
    "Twilight Oculus": "暮光法眼",
    "Crystal Oculus": "棱晶法眼",
    "Purity Oculus": "纯净法眼",
    "Arcane Amplifier": "奥术谐振器",
    "The Flamenweaver": "织焰者",
    "Treelord Staff": "树灵王权杖",
    "Aetherlord Staff": "虚灵领主权杖",
    "Filthlord Staff": "大不净者权杖",
    "Flaming Claw Staff": "焰爪权杖",
    "Icy Claw Staff": "霜爪权杖",
    "Scepter of Mischief": "捣蛋鬼权杖",
    "Drakenstaff": "驭龙权杖",
    "The Purifier": "涤净者",
    "Silvermelt": "水银枢",
    "Sorcwinter": "唤冬巫蛊",
    "The Dynamo": "邪擎", # dynam为希腊语词根，意为"力量"，游戏里该装备效果为释放湮灭术，原词难以直译，故使用高度修饰的译法尝试还原风味，"擎"字体现力量感，也可作"引擎"之意，对应原词直译后的"发电机"含义
    "The Blazeloom": "烈焰织机",
    "Starblesser": "星界赐礼",
    "The Sparkloom": "雷光织机",
    "Wintersting": "寒冬鳌刺",
    ...
    "Fae Plate": "仙灵板甲",
    "Vampiric Vestments": "血族祭服",
    "Dwarven Chainmail": "矮人链甲",
    "Elven Chainmail": "精灵链甲", #？
    "Soulmail": "缚魂链甲",
    "Basilisk Scale Armor": "龙蜥鳞甲",
    ...
    "Arcane Helm": "奥术护盔",
    "Metallic Helm": "钢铁护盔",
    "Fire Frenzy Mask": "癫火面具",
    "Ice Frenzy Mask": "癫狂寒霜面具",
    "Arcane Frenzy Mask": "癫狂奥术面具",
    "Summer Crown": "夏季皇冠",
    "Winter Crown": "冬季皇冠",
    "Spring Crown": "春季皇冠",
    "Autumn Crown": "秋季皇冠",
    "Bloodspike Crown": "血棘冠冕",
    "Earthmeld Boots": "摄灵靴",
    "Travellers Shoes": "旅者之靴",
    "Cantrip Clogs": "戏法师木屐",
    "Timestriders": "岁月行者",
    "Drill Shoes": "靴型钻探械",
    "Winged Shoes": "羽翼之靴",
    ...
    "Ankh": "安卡护符",
    "Drakentooth": "飞龙之牙",
    "Eye Rock Pendant": "眼石吊坠",
    "Amber Cube": "琥珀立方体",
    "Skull Necklace": "颅骨项链",
    "Red Obsidian Shard": "红曜石裂片",
    "Jade Shard": "翡翠裂片",
    "Reality Anchor": "现实稳定锚",
    "Amulet of Undeath": "亡者护符",
    "Vial of Ambrosia": "仙馐涎香",
    "Amulet of Emerald Flame": "碧绿烈焰护符",
    "Monkey Skull Amulet": "猴颅护符",
    "Blood Ruby": "血腥红玉",
    "Thundering Hooves": "雷鸣胫甲",
    "Bramblethorn": "灌木棘丛",
    "Toadthorn": "蟾蜍棘皮",
    "Devilthorn": "恶魔棘刺",
    "Witch Whistle": "女巫哨子",
    "Snowy Fursphere": "雪绒球",
    "Living Emberstone": "活化余烬石",
    ...
    "Fire Fiend Crown": "狱火邪魔冠冕"，
    "Spark Fiend Crown": "烁光邪魔冠冕"，
    "Iron Fiend Crown": "钢铁邪魔冠冕"，
    "Bloodburn Staff": "蚀血法杖"，
    "Thunderforce Staff": "盛雷法杖"，
    "Ice Crystal Staff": "冰晶法杖"，
    "Vampire Wand": "吸血鬼节杖"，
    "Boots of Dramatic Arrival": "惊鸿靴"，
    "Poison Pipe": "毒素吹箭",
    "Time Pipe": "时光吹箭",
    "Ink Pipe": "墨汁吹箭",
    "Ice Pipe": "冰霜吹箭",
...
monsters = {
    ...
    "Storm Troll": "风暴巨魔",
    "Minotaur": "牛头人",
    "Greater Vampire": "吸血鬼长老",
    "Vampiric Mist": "血族迷雾",
    "Aelf": "精灵",
    "Ghostly Mass": "幽灵集群",
    "Faery Arcanist": "仙灵奥术师",
    "Purple Hand": "紫手",
    "Star Swimmer": "星态游荡者", # 是个海星
    "Towering Toadbeast": "大蟾蜍",
    ...
    "Night Hag": "老鬼婆", # DND
    "Red Cyclops": "红色独眼巨人",
    "Giant Floating Skull": "硕巨飞颅",
    "Grey Gorgon": "灰戈尔贡",
    "Efreet": "伊芙利特", # 关键词：火焰、烟雾、精怪、阿拉伯
    "Purple Pachyderm": "紫色韧皮兽",
    "Yeti": "雪人",
    "Void Drake": "虚空巨龙",
    "Cockatrice": "鸡蛇兽",
    ...
    "Rot Fiend": "腐烂恶魔",
    "Ash Fiend": "灰烬恶魔",
    "Bone Shambler Megalith": "庞巨骸骨跛行者",
    "Golden Skull": "金色颅骨",
    "Energy Knight": "能量骑士",
    ...
    "Gemini Twin": "双子座",
    "The Mischief Maker": "恶戏之主",
    "Slime Drake": "史莱姆巨龙",
    "Void Phoenix": "虚空凤凰",
    "Crucible of Pain": "苦痛坩埚",
    "Idol of Fiery Vengeance": "暴烈复仇造像",
    "Concussive Idol": "震撼造像",
    "Idol of Vampirism": "吸血造像",
    "Bone Colossus": "骸骨巨像",
    "Flesh Colossus": "血肉巨像",
    "Giant Nightmare Turtle": "硕巨梦魇龟", 
    "Giant Mass of Eyes": "庞巨眼怪集群",
    "Giant Gorgon": "庞巨戈尔贡",
    "Beastking of Inferno": "炼狱兽尊",
    "Ultimate Mind Devourer": "心灵吞噬者领主",
    "Giant Sack of Filth": "硕巨污秽聚群",
    "True Lamasu": "真·拉马苏",
    "Winterbringer": "凛冬使徒",
    "Moon Mage": "月亮法师",
    "Blood Magus": "鲜血法师",
