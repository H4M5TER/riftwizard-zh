...
法术和能力都可以通过支付角色表中的技能点 (SP) 学习。
可以使用 SP 从角色表单独升级法术，也可以在世界上发现的神殿中单独升级法术。
法术的充能有限。施放一个法术会消耗该法术的一次充能。通过饮用法力药水来恢复充能，在某些关卡中可以在地面上找到。

【控制方式】
C：角色表    S：学习法术    K：学习能力    H: 帮助（本屏幕）
左键单击：移动，向光标位置施放当前所选的法术
右键单击：取消当前法术，返回上层菜单
